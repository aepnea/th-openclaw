...
export type SkillsApplyVersionParams = Static<typeof SkillsApplyVersionParamsSchema>;
export type SkillsApplyVersionResult = Static<typeof SkillsApplyVersionResultSchema>;
